...
public class Main {
    public static void main(String[] args) {
        ...
        Mechanic mec1 = new Mechanic("Tatiana Torres", 1, "Cambios de Aceite");
        Mechanic mec2 = new Mechanic("Jose Martinez", 2, "Cambio de Llantas");
        Mechanic mec3 = new Mechanic("Duvan Olarte", 3, "Sistemas Electricos");
