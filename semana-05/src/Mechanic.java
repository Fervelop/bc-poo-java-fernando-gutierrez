public class Mechanic extends Person {
    ...
    //Constructor
    public Mechanic(String name, String lastName, long phoneNumber, String email, int id, String specialization) {
    ...
    public Mechanic(String name, int id) {
        this(name, "Sin apellido", 0, "sin email", id, "Sin especialización");
    }
    ...
    public void assignJob() {
        if (this.isAvailable) {
            ...
            System.out.println(this.name + " ha sido asignado a un nuevo trabajo.");
        } else {
            System.out.println(this.name + " ya está ocupado. Busque otro mecánico.");
        }
    }
    ...
    public void completeJob() {
        ...
        System.out.println(this.name + " ha finalizado su trabajo. Trabajos completados: " + this.completedJobsCount);
    }
    ...
    public String getRole() {
        return "Mecánico especializado en " + specialization;
    }
