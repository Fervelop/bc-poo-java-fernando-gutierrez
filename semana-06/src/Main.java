...
public class Main {
    public static void main(String[] args) {
        ...
        services[2] = new TireChangeService("Servicio de cambio de llantas", 80000, 10000, 2, 20000);
...
//            System.out.println(s.basicInfo());
        ...
        Repairable rep = new TireChangeService("Servicio de cambio de llantas", 80000, 10000, 2, 20000);
        ...
        TimeTrackable track = new TireChangeService("Servicio de cambio de llantas", 80000, 10000, 2, 20000);

        track.startJob();
        track.finishJob();

        System.out.println("Duración del trabajo: " + track.durationJob() + " horas");
